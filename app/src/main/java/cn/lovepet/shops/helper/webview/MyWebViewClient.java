package cn.lovepet.shops.helper.webview;
...
import cn.lovepet.shops.util.CheckNetwork;
import cn.lovepet.shops.view.ui.activity.publical.WebActivity;
...
//        Log.e("jing", "----url:" + url);
    ...
    private void handleOtherwise(Activity activity, String url) {
        ...
        if (ApplicationUtil.isApplicationAvilible(activity, appPackageName)) {
            startActivity(url);
        }
    }
